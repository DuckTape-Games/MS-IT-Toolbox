<#
Runs a Microsoft Defender full-system scan and returns JSON results
#>
...
$result = [PSCustomObject]@{
    ...
    FullScanStartTime = $statusAfter.FullScanStartTime
    FullScanEndTime = $statusAfter.FullScanEndTime
    FullScanAge = $statusAfter.FullScanAge
